...
public class JoinTests {
    ...
    public void 내부조인을_이용한_조회_테스트 () {
        ...
        //when
        String jpql = "SELECT m FROM menu_section06 m JOIN m.categoryCode c";
    ...
    public void 외부조인을_이용한_조회_테스트() {
        ...
        //when
        String jpql = "SELECT m.menuName, c.categoryName FROM menu_section06 m RIGHT JOIN m.categoryCode c "
    ...
    public void 페치조인을_이용한_조회_테스트 () {
        ...
        //when
        String jpql = "SELECT m FROM menu_section06 m JOIN FETCH m.categoryCode c";
        List<Menu> menuList = entityManager.createQuery(jpql, Menu.class).getResultList();
