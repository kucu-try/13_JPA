...
public class A_EntityManagerLifeCycleTests {
    ...
    * thread-safe 하기 때문에 여러  스레드가 동시에 접근해도 안전하므로 서로 다른 스레드 간 공유해서 사용한다
    * thread-safe한 기능을 요청 스코프마다 생성하기에는 비용 부담이 크므로
    ...
    * */
    ...
    private EntityManager entityManager;  //세션 요청받아서 쓰기 때문에 static을 붙이지 않는다
